  ...
  return (
    ...
    >
      ...
      <ellipse cx="240" cy="152" rx="210" ry="68"
        fill="none" stroke="rgba(22,135,255,0.06)" strokeWidth="1" />
      <ellipse cx="240" cy="152" rx="172" ry="52"
        fill="none" stroke="rgba(22,135,255,0.09)" strokeWidth="1" />
      <ellipse cx="240" cy="152" rx="132" ry="38"
        fill="none" stroke="rgba(22,135,255,0.12)" strokeWidth="1" />
      <ellipse cx="240" cy="152" rx="92" ry="26"
        fill="none" stroke="rgba(22,135,255,0.16)" strokeWidth="1" />

      {/* ── Diffusion gradient above bar ── */}
      <defs>
        <linearGradient id="barGlow" x1="0" y1="0" x2="1" y2="0">
          <stop offset="0%" stopColor="rgba(22,135,255,0)" />
          <stop offset="25%" stopColor="rgba(22,135,255,0.22)" />
          <stop offset="50%" stopColor="rgba(22,135,255,0.4)" />
          <stop offset="75%" stopColor="rgba(22,135,255,0.22)" />
          <stop offset="100%" stopColor="rgba(22,135,255,0)" />
        </linearGradient>
        <linearGradient id="fieldFade" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="rgba(22,135,255,0.08)" />
          <stop offset="100%" stopColor="rgba(22,135,255,0)" />
        </linearGradient>
        <radialGradient id="centerGlow" cx="50%" cy="50%" r="50%">
          <stop offset="0%" stopColor="rgba(22,135,255,0.10)" />
          <stop offset="100%" stopColor="rgba(22,135,255,0)" />
        </radialGradient>
      </defs>
      ...
      <line x1="140" y1="152" x2="110" y2="195"
        stroke="rgba(22,135,255,0.4)" strokeWidth="0.75" strokeDasharray="3 3" />
      {/* Center signal ray */}
      <line x1="240" y1="153" x2="240" y2="210"
        stroke="rgba(22,135,255,0.5)" strokeWidth="0.75" strokeDasharray="3 3" />
      {/* Right signal ray */}
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ backgroundColor: "rgba(22,135,255,0)" }}
        aria-hidden="true"
      />
      <div
        className="absolute bottom-0 left-0 h-px w-0 group-hover:w-full transition-all duration-500"
        style={{ backgroundColor: "rgba(22,135,255,0.4)" }}
        aria-hidden="true"
      />
    </article>
  );
